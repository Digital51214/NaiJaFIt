...
class Page5ProfessionalSupport extends StatefulWidget {
  ...
  @override
  State<Page5ProfessionalSupport> createState() => _Page5ProfessionalSupportState();
}
...
class _Page5ProfessionalSupportState extends State<Page5ProfessionalSupport>
  ...
  Future<void> _handleNext() async {
    ...
    if (user != null) {
      try { await AuthService.instance.updateUserProfile(userId: user.id); }
      catch (e) { debugPrint('Page5 API error: $e'); }
    }
            ...
            children: [
              Text(
                ...
                style: GoogleFonts.poppins(
                    fontSize: 16.sp, fontWeight: FontWeight.w700, color: Colors.black, height: 1.3),
              ),
              SizedBox(height: 1.h),
              Text(
              ...
              _optionCard('yes', 'Yes', 'I work with a professional',           Icons.check, Colors.green),
              SizedBox(height: 1.h),
              _optionCard('no',  'No',  "I don't currently work with anyone",   Icons.close, Colors.red),
            ],
          ),
        ),
      ),
  ...
  Widget _optionCard(String value, String title, String sub, IconData icon, Color iconColor) {
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(title, style: GoogleFonts.poppins(fontSize: 9.sp, fontWeight: FontWeight.w600)),
                  SizedBox(height: 5,),
                  Text(sub,   style: GoogleFonts.poppins(fontSize: 8.sp, color: Colors.grey[500])),
                ],
              ),
            ),
            AnimatedContainer(
