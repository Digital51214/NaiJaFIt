...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  void _navigateNext() {
    if (_currentPage < _totalPages - 1) {
      ...
      // ✅ On page 8, go directly to Thank You screen
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => Thankyouscreen(onboardingData: _onboardingData),
        ),
      );
    }
  }
  ...
  void _onPageChanged(int index) {
    setState(() {
      ...
      // ✅ Weight loss expectations page auto-enabled
      if (_currentPage == 4) {
        _isNextEnabled = true;
      } else {
  ...
  // ✅ Page 5 auto enabled, baqi child pages se control hoga
