        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 1.h),
              Text('Select the challenge that resonates most with you',
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(c['title'],
                                    style: GoogleFonts.poppins(
                                        fontSize: 10.sp, fontWeight: FontWeight.bold, color: Colors.black87)),
                                Text(c['sub'],
                                    style: GoogleFonts.poppins(fontSize: 8.4.sp, color: Colors.grey[500])),
                              ],
                            ),
                          ),
                          AnimatedContainer(
                            duration: const Duration(milliseconds: 200),
                            width: 5.2.w, height: 5.2.w,
                            decoration: BoxDecoration(
